...
public class Card implements Comparable<Card> {
    ...
    public int compareTo(Card other) {
        ...
        int aIndex = Arrays.asList(CardValue.values()).indexOf(this.value);
        int bIndex = CardValue.valueOf(String.valueOf(other.value)).ordinal();

        cardDifference = aIndex - bIndex;
